        ...
        <>
            ...
            <main className="max-w-screen-xl mx-auto mt-5">
                <div className="flex flex-wrap">
                    <div className="px-5 mb-7 w-full md:w-7/12">
                        <div className="w-full mb-4 card-zoom">
                            <Image className={"w-full rounded-lg card-zoom-image"} width={700} height={500} objectFit="cover" src={activeImage} alt="" />
                        </div>
            ...
            <div className="mt-12 bg-gradient-to-t from-gray-100 to-transparent">
                <div className="max-w-screen-2xl mx-auto">
                    <h1 className="ml-10 text-yellow-500 text-3xl mb-7">Related Projects</h1>
